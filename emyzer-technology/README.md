...
>
> Emyzer Technology is a fictional organisation created for this GRC portfolio. All entities, personnel, systems, policies, risk entries, and regulatory scenarios described in this repository are invented for professional demonstration purposes. Framework and regulatory references — ISO 27001:2022, NIST CSF, EU AI Act, GDPR, and others — are accurate as of the document dates; their application to Emyzer Technology is illustrative only. No real organisation, individual, or incident is represented. This portfolio was developed to demonstrate applied GRC competency across policy architecture, risk programme design, business continuity, AI governance, and M&A integration using a fictionalized enterprise environment.
...
**GRC maturity stage at Phase 1:** Foundational governance build — 10 core information security policies, a structured risk assessment programme, business continuity documentation, and full implementation in ServiceNow GRC, all established prior to the Veridian AI acquisition.
...
All artefacts in this portfolio are listed below, organised by programme area. Links use paths relative to this file. Status reflects the current development state of each document.
...
Raw policy exports from ServiceNow GRC. These PDFs provide platform-level proof of policy implementation, capturing ownership, approval workflows, validity periods, and compliance mappings as generated by the platform.
...
These policies govern Emyzer Nexus as the post-acquisition parent entity. They extend the Phase 1 governance baseline to address AI governance under the EU AI Act and the expanded privacy and training obligations arising from the Veridian AI acquisition. Phase 1 policies remain in effect as subsidiary documentation.
...
Supporting documents for the EU AI Act compliance programme. These files provide the operational detail underpinning the AI Governance Policy: a formal inventory of AI systems, an Article-by-Article control mapping, and risk assessments for the inherited Veridian AI systems.
...
Documents governing the governance integration of Veridian AI into the Emyzer Nexus structure: which policies apply to the acquired entity, what documentation requires remediation, and in what order.
