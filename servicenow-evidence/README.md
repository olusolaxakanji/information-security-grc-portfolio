...
|----------|-------------|---------------------|
| `Access Control Policy.pdf` | Defines access authorization, authentication requirements, RBAC/ABAC implementation, and access review procedures | COBIT, RBAC, ABAC |
| `Business Continuity and Disaster Recovery Policy.pdf` | Establishes business continuity management system (BCMS), disaster recovery procedures, and operational resilience requirements | ISO/IEC 22301 |
| `Incident Management Policy.pdf` | Outlines incident detection, response procedures, escalation paths, and post-incident review processes | NIST, ITIL |
| `Information Security Policy.pdf` | Parent policy defining the organization's overall security governance framework, objectives, and accountability structure | NIST, ISO 27001 |
| `Risk Management Policy.pdf` | Documents risk identification, assessment methodology, treatment options, and ongoing risk monitoring requirements | NIST RMF, ISO 31000 |
...
The formatting reflects ServiceNow's native output. No cleanup has been applied—these are the raw artifacts as the platform generates them.
...
|---------------|-----------------|
| `Access Control Policy.pdf` | `/access-control/access-control-policy.md` |
| `Business Continuity and Disaster Recovery Policy.pdf` | `/business-continuity/bcdr-policy.md` |
| `Incident Management Policy.pdf` | `/incident-management/incident-response-policy.md` |
| `Information Security Policy.pdf` | `/governance/information-security-governance-policy.md` |
| `Risk Management Policy.pdf` | `/risk-management/risk-assessment-policy.md` |
