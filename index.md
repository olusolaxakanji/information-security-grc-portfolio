...
Six directories. Each contains complete, audit-ready documentation — not outlines or templates.
...
| **[Risk Assessments →](https://github.com/olusolaxakanji/information-security-grc-portfolio/tree/main/risk-assessments)** | Hybrid 5×5 risk methodology, 15-entry asset register (including one budget-blocked Critical risk documented openly), and a risk appetite statement | ISO 31000, NIST SP 800-30 |
...
The case study follows a deliberate narrative: Emyzer Technology (Phase 1 GRC build) acquires Veridian AI (AI-native startup with two unassessed High-Risk AI systems) and forms Emyzer Nexus (Phase 2 post-acquisition governance). This is the governance problem most portfolios never address — how a programme absorbs an acquired entity, handles inherited AI systems under the EU AI Act, and maintains compliance continuity through material organisational change.
...
This is live, operational work — not a simulation. I built and maintain the GRC programme for the Idowu Ajiri Foundation in my role as GRC Analyst for the organisation. The Foundation operates under dual US-Nigeria jurisdiction: incorporated under [IRS 501(c)(3)](https://www.irs.gov/charities-non-profits) in the United States and registered with the [Corporate Affairs Commission (CAC)](https://www.cac.gov.ng) in Nigeria, with AML/CFT obligations under [SCUML](https://www.nfiu.gov.ng) (supervised by the Nigerian Financial Intelligence Unit), data protection obligations under the [Nigeria Data Protection Act 2023](https://ndpc.gov.ng), and cross-border fund flow screening obligations under [OFAC](https://ofac.treas.gov). Governing a dual-jurisdiction nonprofit — where US federal tax-exempt compliance, Nigerian corporate law, AML/CFT registration, and data protection obligations intersect simultaneously — is a materially different problem from single-jurisdiction enterprise GRC.
...
|---|---|
| **AI governance** | EU AI Act article-by-article control mapping (Arts 9–15, 72, 73); High-Risk classification of two inherited systems; 8-entry AI risk assessment with 2 Critical findings |
| **M&A GRC integration** | Integration Charter establishing Day-0 policy hierarchy; Rationalization Roadmap tracking 14 policy updates; 15-entry M&A risk register with treatment owners |
| **Risk programme design** | End-to-end hybrid methodology; asset register with a budget-blocked Critical risk documented openly rather than papered over; domain-specific risk appetite thresholds |
...
| **Business continuity** | Full ISO 22301 BCP with CMT runbook, 5-scenario recovery strategies, multi-type exercise programme, and clause-level framework alignment table |
| **Dual-jurisdiction compliance** | Live US-Nigeria nonprofit GRC programme under IRS, CAC, SCUML, NDPA 2023, and OFAC — built and maintained operationally |
...
| **AI vendor risk** | AI Vendor Due Diligence Addendum extending TPRM for model transparency, training data provenance, bias testing, EU AI Act compliance, and AI error liability |

---

> **Practitioner disclaimer.** The Emyzer Technology, Emyzer Nexus, and Veridian AI case study is a fictional simulation created for professional demonstration purposes. All personnel, systems, risk entries, vendor relationships, and regulatory scenarios in that case study are invented. Framework and regulatory references are accurate as of the document publication dates. `[VERIFY]` tags throughout the documentation flag regulatory citations where Legal Counsel would need to confirm precise applicability — they indicate professional rigour, not incomplete drafting. The Idowu Ajiri Foundation is a real organisation; that programme documents live, operational work.

---

[View full repository on GitHub →](https://github.com/olusolaxakanji/information-security-grc-portfolio)
